...
let JOBS = [
  ...
  { id:3, featured:true,  title:'Lead SDET / Backend Automation QA Engineer',   company:'Datadog',    logo:'https://logo.clearbit.com/datadoghq.com',  location:'🌍 Remote (Global)',      salary:'$150k – $200k', tags:['QA / SDET','Python','Playwright','API Testing'], filter:['qa','python','devops'], age:'3h ago', url:'https://careers.datadoghq.com/' },
  { id:4, featured:false, title:'Senior QA Engineer – Microservices',           company:'Spotify',    logo:'https://logo.clearbit.com/spotify.com',    location:'🌍 Remote (Worldwide)',   salary:'$140k – $185k', tags:['Java','RestAssured','Kafka','Cypress'],  filter:['qa','java','db'],   age:'4h ago', url:'https://www.lifeatspotify.com/jobs' },
  { id:5, featured:false, title:'Senior Node.js Backend Engineer',              company:'Vercel',     logo:'https://logo.clearbit.com/vercel.com',     location:'🌍 Remote (Worldwide)',   salary:'$140k – $190k', tags:['Node.js','TypeScript','PostgreSQL','Redis'],filter:['node','db'],     age:'4h ago', url:'https://vercel.com/careers' },
  { id:6, featured:false, title:'Senior Python Backend Engineer',               company:'Anthropic',  logo:'https://logo.clearbit.com/anthropic.com',  location:'🌍 Remote (US)',          salary:'$180k – $250k', tags:['Python','FastAPI','PostgreSQL','AWS'],   filter:['python','db','devops'], age:'5h ago', url:'https://www.anthropic.com/careers' },
  { id:7, featured:false, title:'Backend Engineer – Microservices (Java)',      company:'Netflix',    logo:'https://logo.clearbit.com/netflix.com',    location:'🌍 Remote (US)',          salary:'$160k – $210k', tags:['Java','Spring Boot','Cassandra','Kafka'],  filter:['java','db','devops'], age:'1d ago', url:'https://jobs.netflix.com' },
  { id:8, featured:false, title:'Senior .NET Developer – Microservices & Cloud', company:'Stack Overflow', logo:'https://logo.clearbit.com/stackoverflow.com', location:'🌍 Remote (Worldwide)', salary:'$140k – $190k', tags:['C#','.NET Core','Redis','SQL Server'], filter:['dotnet','db'], age:'1d ago', url:'https://stackoverflow.co/company/careers' },
  { id:9, featured:false, title:'Senior Go Engineer – Distributed Systems',     company:'Cloudflare', logo:'https://logo.clearbit.com/cloudflare.com', location:'🌍 Remote (Worldwide)',   salary:'$155k – $200k', tags:['Go','Rust','PostgreSQL','gRPC'],         filter:['go','rust','db'],    age:'1d ago', url:'https://www.cloudflare.com/careers/' },
  { id:10, featured:false, title:'Rust Systems Engineer – Core Infrastructure',  company:'Discord',    logo:'https://logo.clearbit.com/discord.com',    location:'🌍 Remote (Americas)',    salary:'$160k – $215k', tags:['Rust','Elixir','ScyllaDB','Redis'],        filter:['rust','db'],        age:'2d ago', url:'https://discord.com/careers' }
];
